...
/*                                                                          */
/****************************************************************************/
// plugins/inspector/float64x.cc -- impl for builtin double hex inspector
...
bool InspectorPluginFloat64Hex::convertFromBytes(
    ...
    std::snprintf(outstr, outstr_n, "%la", num);
    return true;
}

bool InspectorPluginFloat64Hex::convertToBytes(
