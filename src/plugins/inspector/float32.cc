...
/*                                                                          */
/****************************************************************************/
// plugins/inspector/float32.cc -- impl for builtin float inspector
...
bool InspectorPluginFloat32::convertFromBytes(
    ...
    std::snprintf(outstr, outstr_n, "%." STRINGIFY(FLT_DIG) "g", num);
    return true;
}

bool InspectorPluginFloat32::convertToBytes(
