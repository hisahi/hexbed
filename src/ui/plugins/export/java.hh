...
/*                                                                          */
/****************************************************************************/
// ui/plugins/export/java.hh -- header for builtin Java source code exporter

#ifndef HEXBED_UI_PLUGINS_EXPORT_JAVA_HH
#define HEXBED_UI_PLUGINS_EXPORT_JAVA_HH
...
struct ExportPluginJavaSettings {
...
class ExportPluginJava : public LocalizableExportPlugin {
  public:
    ExportPluginJava(pluginid id);
...
#endif /* HEXBED_UI_PLUGINS_EXPORT_JAVA_HH */
